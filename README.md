...
O programa foi desenvolvido para armazenar as notas informadas pelo usuário em uma lista. Para isso, utilizei uma estrutura de repetição que solicita cada nota e verifica se o valor está entre 0 e 10 antes de armazená-lo.
